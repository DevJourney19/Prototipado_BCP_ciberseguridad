    ...
    <div class="flex">
      ...
      <div class="iniciar_sesion">
        ...
        <form action="php/user_login.php" method="POST" autocomplete="off">
          <div>
            <input type="text" placeholder="Numero de tarjeta de debido o credito" name="tarjeta" autocomplete="off">
          </div>
          <div class="group">
          ...
          <div>
            <input type="password" placeholder="Clave de internet de 6 digitos" name="pin" autocomplete="off">
          </div>
          <?php if ($error != null) : ?>
